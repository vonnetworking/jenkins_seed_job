...
config.mdproducts.each { mdname, data ->
    ...
    def gradleTasks = (! data.gradleTasksBranches.isEmpty()) ? data.gradleTasksBranches : config.gradleTasksBranchesDefault
    ...
    println "The folder ${data.bitbucketprojectkey} has the job ${pipelineFolder}~${data.bitbucketprojectrepo}-branches"
    println "The job ${pipelineFolder}~${data.bitbucketprojectrepo}-branches has the CD Pipeline: ${cdPipeline}"

    folder("${data.bitbucketprojectkey}") {
        displayName("${data.bitbucketprojectname}")
    }

    new MDBranchesPipelineBuilder(
        pipelineName: "${pipelineFolder}~${data.bitbucketprojectrepo}~branches",
